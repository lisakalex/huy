...
?>
    ...
    <div style="text-align: center;">
        ...
        <h1> HYIP performance index</h1>
        <p><?= $hyipsu ?> companies listed. HPI <?= $today_totalu ?>. Day change <?= $change_totalu ?>
            (<?= $change_totalpu ?>)</p>
    </div>
...
// Create a horizontal scrollbar with previe and place it underneath the date axis
        ...
        <div style=" width: 15%; background-color: white; padding: 4% 0 0 4%;">
            <div style="margin: 10px 0 10px 0">
                <img src="https://forexprofits.biz/images/FP-125.gif">
            </div>
            <div style="margin: 10px 0 10px 0">
