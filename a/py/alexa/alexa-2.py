...
def get_source():
    ...
    mon = mon.replace("www.", "")
    # monitor = "https://elite-monitor.com"
    # if monitor.find("https://") == -1:
    #     mon = monitor.replace("http://", "")
    # else:
    #     mon = monitor.replace("https://", "")
    ...
    try:
        # source = requests.get('https://elite-monitor.com')
        # source = requests.get('https://siterankdata.com/' + mon)
        ...
        driver.set_t
        driver.get(monitor)
        driver.save_screenshot("/var/www/html/internetspeed/pic/" + mon + ".png")
