...
</div>    <div id="wrapperHandler" class="">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-5"><strong class="badge badge-light d-block mb-2"
                                                                                  ...
                                                                                  data-original-title="Active Campaigns / Total Campaigns">0</strong>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-7">
                                                    ...
                                                    <div class="col-md-5"><strong
                                                                class="badge badge-light d-block mb-2">0</strong>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-7">
                                                    ...
                                                    <div class="col-md-5"><strong class="badge badge-light d-block mb-2"
                                                                                  data-toggle="tooltip"
                                                                                  data-placement="bottom" title=""
                                                                                  data-original-title="Active Campaigns / Total Campaigns">8</strong></div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-7">
                                                    ...
                                                    <div class="col-md-5"><strong class="badge badge-light d-block mb-2"
                                                                                  data-toggle="tooltip"
                                                                                  data-placement="bottom" title=""
                                                                                  data-original-title="Active Referred Users / Total Referred Users ">0</strong>
                                                    </div>
                                                </div>
                                                <div class="card-header">
                                                    <ul class="nav nav-tabs card-header-tabs">
