...
class query extends input
{
    ...
    public function __construct(bool $debug = FALSE)
    {
        ...
        (bool) $this->post = TRUE;
        (array) $this->cols =  ['AppName', 'CompName', 'AppVersion', 'EnvName', 'Type', 'DeployDate'];
        (array) $this->tables = ['tbl_Component', 'tbl_AppDeployment', 'tbl_Environment', 'tbl_CompDeployment', 'tbl_Application'];
        $this->openDB();
        $this->getNames();
        $this->constructForm();
    }
