 ...
 * http://da-1.com/submit.php?AppName=crs_batch&EnvName=SOST4&AppVersion=5.0.2&MarvalRef=CHG-456254&EnvType=test&Components=archive_CRSRDPRO.sh,crsbus_jobautographfile.sh
 */
$filtered = $fm->GET();
