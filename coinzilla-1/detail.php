...
$clean_hyip_url = after('//', $url);
$html = file_get_html('https://siterankdata.com/' . $clean_hyip_url);
$dailyUniqueVisitors = trim($html->find('h3.no-margins', 0)->plaintext);
$monthlyVisitors = trim($html->find('h3.no-margins', 1)->plaintext);
$yearlyVisitors = trim($html->find('h3.no-margins', 2)->plaintext);
...
if (mysqli_stmt_prepare($stmt, $sql)) {
    ...
    mysqli_stmt_bind_result($stmt, $t, $p, $monitor_images);
    while (mysqli_stmt_fetch($stmt)) {
        $hyip_rgaph[] = array('date' => $t, 'value' => $p);
    }
}
            ...
            <div class="row row-flex">
                ...
                <div class="col-md-8">
                    ...
                    <div>
                        ...
                        <p>
                            Daily Unique Visitors <?= $dailyUniqueVisitors ?>
                        </p>
                        <p>
                            Monthly Visitors <?= $monthlyVisitors ?>
                        </p>
                        <p>
                            Yearly Visitors <?= $yearlyVisitors ?>
                        </p>
                    </div>
...
<script src="https://cdn.amcharts.com/lib/4/charts.js"></script>
<script src="https://cdn.amcharts.com/lib/4/themes/animated.js"></script>
<script data-hyip_rgaph='<?= $hyip_rgaph ?>' data-hyip_pie='<?= $hyip_pie ?>' src="./assets/js/me.js"></script>
</body>
</html>
