...
<body class="homepage__body overflow__limited homepage-v2" style="background: white">
<div id="wrap__header" style="background: #f8fcfe">
    <header>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
...
<div style=" width: 70%; background-color: white; margin: auto">
    ...
    echo "<th style=\" width: 200px\">Index</th>";
    echo "<th style=\" width: 200px\">Day</th>";
    echo "<th style=\" width: 200px\">Day %</th>";
    echo "<th style=\" width: 200px\">Details</th>";
    ...
    echo "</table>";
    ?>
    <div class="" style="text-align: center; margin: 5% 0 0 0; padding-bottom: 3%">
        <a href="<?= $all_banners['Bottom'][1] ?>"><img src="<?= $all_banners['Bottom'][0] ?>"
                                                        alt="" class=""></a>
    </div>
</div>
<!--</div>-->
<footer  style="background: #f8fcfe; padding-top: 5%">
