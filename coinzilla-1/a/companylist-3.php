...
<div id="wrap__page">
    <section class="content page-top-slider top-slider-spacing" style="margin-bottom: 0px">
        <div class="container">
            <div class="row">
    ...
    <section class="content multi-features" style="background: #FFFFFF">
        <div class="container">
            <div style="  background-color: white; margin: auto">
                ...
                <table id="myTable" class="stripe row-border hover table-responsive">
                    ...
                    <tr>
                        ...
                        <th style=" width: ">URL</th>
                        <th style=" width: ">Index</th>
