...
<div class="me-side-banner" style="  background-color: transparent; padding: 15% 0 0 5%;   position: fixed ">
...
<div class="me-side-banner" style="width: 100%; background-color: transparent; padding: 15% 5% 0 0;  position: fixed; text-align: right">
    <div style="margin: 10px 0 10px 0">
        ...
        <div class="container">
            <div class="row row-flex">
                ...
                <div class="col-md-6">
                    ...
                    <br>
                    <div class="mascot" style="padding-bottom: 30px">
                        <img src="../assets/images/mascot/stocks.jpg" class="img-fluid">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card">
                    ...
                    <br>
                    <div class="mascot" style="padding-bottom: 10px">
                        <img src="../assets/images/mascot/Investment%20Market.jpg" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
