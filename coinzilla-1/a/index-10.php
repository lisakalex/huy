...
$all_banners['250x250-1'] = array("https://solidtradebank.com/assets/banners/solid-trade_250x250.gif", "https://solidtradebank.com/\" target=\"_blank");
$all_banners['300x250-1'] = array("./assets/images/300x250.png", "https://solidtradebank.com/\" target=\"_blank");
$all_banners['300x600-1'] = array("./assets/images/300x600-1.jpeg", "https://solidtradebank.com/\" target=\"_blank");
    ...
    <section class="content multi-features">
        <div class="container">
            <div class="row row-flex">
                <div class="col-md-10 bg__simple_lines_left">
                    ...
                    <p>
                        <a href="../../contact/index.html" class="dashed underlined">I want to know more ⟶</a>
                    </p>
                </div>
                <div class="col-md-2">
                    <div class="row">
                    ...
                    <div class="me-flex-1">
                        <a href="<?= $all_banners['300x250-1'][1] ?>"><img class="me-contain" src="<?= $all_banners['300x250-1'][0] ?>" alt=""></a>
                    </div>
                    <div class="me-flex-1">
                        <a href="<?= $all_banners['300x600-1'][1] ?>"><img class="me-contain" src="<?= $all_banners['300x600-1'][0] ?>" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
