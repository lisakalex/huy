...
function passwordChanged() {
    echo "<script type=\"text/javascript\">passwordChanged();</script>";
}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <form action="change-password.php" method="post"
                                              onsubmit="return validateFormPass()">
                                            <input type="hidden" name="pass" value="da">
                                            <div class="form-group">
                                                <label for="currentPassword">Current Password</label>
                                                <input type="password" class="form-control" id="currentPassword"
                                                       name="pwd_old" placeholder="Current Password"
                                                       required="">
                                            </div>
                                            <div class="form-group">
                                                <label for="newPassword"><span data-toggle="tooltip"
                                                                               data-placement="right" title=""
                                                                               data-original-title="Your password must contain a minimum of 8 characters with at least one Uppercase, Symbol and Number.">ⓘ</span>
                                                    New Password</label>
                                                <div class="relative">
                                                    <input type="password" class="form-control password-strength"
                                                           id="newPassword" name="pwd_new"
                                            ...
                                            <div class="form-group">
                                                <label for="retypePassword"><span data-toggle="tooltip"
                                                                                  data-placement="right" title=""
                                                                                  data-original-title="Must be the same with the new password.">ⓘ</span>
                                                    Retype Password</label>
                                                <input type="password" class="form-control" id="retypePassword"
                                                       name="pwd_new" placeholder="Retype Password"
                                                       required="">
                                            </div>
                                            <hr>
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary"><span class="icon"><span
                                                                class="far fa-check submit-icon"></span></span> Change Password
                                                </button>
                                            </div>
                                            <div class="modal fade" tabindex="-1" role="dialog" id="modal">
                                                <div class="modal-dialog">
...
<?php
if ($show == "passwordChanged") {
    passwordChanged();
}

if ($show == "wrongPassword")
    wrongPassword();
?>
</body>
</html>
