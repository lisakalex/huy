...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=BenchNine:wght@300&family=Jaldi&display=swap" rel="stylesheet">
                        ...
                        <div class="navbar-collapse justify-content-end collapse toggle-content" id="mainNavBar">
                            <ul class="nav">
                                <li class="nav-item active">
                                    <a class="nav-link dot" href="overview.php">Overview<span
                                                class="display-mobile icon-wrapper"><span
                                                    class="far fa-long-arrow-right"></span></span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link dot" href="addbanner.php">Add banner<span
                                                class="display-mobile icon-wrapper"><span
                                                    class="far fa-long-arrow-right"></span></span></a>
                                </li>
                                ...
                                <li class="nav-item dropdown nav-user-account mr-0 ">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a class="dropdown-item  " href="billing.php"><span
                                                    class="far fa-credit-card-blank icon"></span> Billing Center</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item  " href="profile.php"><span
                                                    class="far fa-user-cog icon"></span> My Profile</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item  " href="change-password.php"><span
                                                    class="far fa-user-shield icon"></span> Change Password</a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item  " href="delete-account.php"><span
                                                    class="far fa-users icon"></span> Delete Account</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 text-md-right">
                        <a href="https://coinzilla.com/terms/" target="_blank">Terms & Conditions</a> - <a
                                ...
                                href="https://coinzilla.com/cookie-policy/"
            ...
            <div class="col-md-6 col-lg-8 col-sm-8 col-11 mx-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!--                            <h1>Send Bitcoin</h1>-->
                        <!--                            <p class="placeholder">-->
                        <!--                                Please scan QR code or copy BTC address</p>-->
                        <!--                        </div>-->
                        <!--                    </div>-->
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div style="margin-top: 10%">
                                    <h1>Send Bitcoin<img src="assets/images/bitcoin.png" class="me-icon" height="40"
                                                         alt=""></h1>
                                    <p class="me-placeholder">
                                        Please scan QR code or copy BTC address</p>
                                </div>
                                <div class="line-bellow mt-3"></div>
                                <div style="text-align: center">
                                    <img src="../qr/php/qr_img.php?d=<?= $qr ?>&s=6" alt="btc">
                                </div>
                                <div style="text-align: center">
                                    <p style="font-size: 14px" id="demo"></p>
                                    <img src="assets/images/30.gif" alt="da">
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div style="text-align: center; margin-bottom: 20%; margin-top: 10%">
                                ...
                                <div style="display: flex; flex-direction: row; margin-bottom: 10%">
                                    <div style="">
                                        ...
                                        <div class="copytooltip" style="">
                                            <div onclick="copyFunction('myInput', 'myTooltip')"
                                                 onmouseout="outFunc('myTooltip', 'amount')">
                                        ...
                                        <div style="">
                                            <input size="10" type="text" value="<?= $btc ?>" id="myInput"
                                                   style="border: 0; outline: none; color: #536677; font-size: 14px;">
                                        </div>
                                    </div>
                                </div>
                                <div style="display: flex; flex-direction: row; margin-bottom: 10%">
                                    <div style="">
                                        <label for="btcAddress">BTC Deposit Address</label>
                                        <div class="copytooltip" style="margin-top: auto;">
                                            <div onclick="copyFunction('myInput1', 'myTooltip1')"
                                                 onmouseout="outFunc('myTooltip1', 'address')">
                                        ...
                                        <div style="">
                                            <input size="43" type="text" value="<?= $newaddress ?>" id="myInput1"
                                                   style="border: 0; outline: none; font-size: 12px;  color: #536677">
                                        </div>
                                    </div>
                                </div>
                                <div style="margin-bottom: 30%" class="placeholder">
