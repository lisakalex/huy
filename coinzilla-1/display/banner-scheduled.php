                                                    ...
                                                    <div class="">
                                                        <div class="card-body">
                                                            ...
                                                            <ul class="nav nav-tabs card-header-tabs">
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class=" nav-link active" href="banner-scheduled.php">Scheduled</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                        ...
                                                                        <div class="container-fluid">
                                                                            <div class="row align-items-center">
                                                                                ...
                                                                                <div class="col-md-7 list-marketplace">
                                                                                    ...
                                                                                    <div class="sub-title">days total <?= $banner['days'] ?>&nbsp;&nbsp;|&nbsp;&nbsp;days left <?= $banner['days'] ?>
