                        ...
                        <form action="" method="POST" onsubmit="return validateFormPass()">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label for="password">
                                            <span data-toggle="tooltip" data-placement="right" title="" data-original-title="Your password must contain a minimum of 10 characters with at least one Uppercase, Symbol and Number">
                                    ...
                                    <div class="form-group">
                                        <label for="repeatPassword">
                                            <span data-toggle="tooltip" data-placement="right" title="" data-original-title="Must be the same with the new password">
                                                <b style="color: red">&ast;&nbsp;</b>ⓘ
                                            </span>
                                            Retype Password
                                        </label>
