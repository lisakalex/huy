                                    ...
                                    <div style="padding-bottom: 5% ">
                                        <div class="form-security deposit-form daa2" style="">
                                            <div style="">
                                                <div style="display: flex; flex-direction: row;">
                                                    <div style="">
                                                        <img src="../qr/php/qr_img.php?d=bitcoin:tb1qtyzf0p3jqn5802fd62zhjzxgh3vaczax3qs04s?amount=0.00593887&amp;s=6">
                                                    </div>
                                                ...
                                                <div style="display: flex; flex-direction: row;">
                                                    <div style="width: 50%">
                                                        <div style="display: flex; flex-direction: row; margin-bottom: 20px">
                                                            ...
                                                            <div style="">
                                                                <input size="8" type="text" value="0.00593887" id="myInput" style="border: 0; outline: none; color: #536677">
                                                            </div>
                                                        ...
                                                        <div style="display: flex; flex-direction: row;">
                                                            <div style="">
                                                                ...
                                                                <!--                                                                    <b>--><!--?//= $newaddress ?--><!--</b>-->
                                                                <input size="43" type="text" value="tb1qtyzf0p3jqn5802fd62zhjzxgh3vaczax3qs04s" id="myInput1" style="border: 0; outline: none; font-family: monospace; color: #536677">
...
<!--                                                            <input type="hidden" name="address" value="tb1qtyzf0p3jqn5802fd62zhjzxgh3vaczax3qs04s">-->
