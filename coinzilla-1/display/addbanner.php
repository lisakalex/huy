                        ...
                        <form action="pay.php" id="addbanner" method="POST">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label for="slot">
                                            <span data-toggle="tooltip" data-placement="right" title="" data-original-title="Please enter the number of slots required">
                                    ...
                                    <div class="form-group">
                                        <label for="banner_id">
                                            <span data-toggle="tooltip" data-placement="right" title="" data-original-title="Choose the banner ID">
                                                <b style="color: red">&ast;&nbsp;</b>ⓘ
                                            </span>
                                            Banner ID
                                        </label>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="email" id="email_label" class="col-form-label"><b style="color: red">&ast;&nbsp;</b>Website URL</label>
                                        <input type="text" class="form-control" id="email" name="site" placeholder="https://my_site.com" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="days">
                                            <span data-toggle="tooltip" data-placement="right" title="" data-original-title="Please choose the number of day required">
                                                <b style="color: red">&ast;&nbsp;</b>ⓘ
                                            </span>
                                            Number of days
                                        </label>
...
<!--                                        </label>-->
                                        <label for="start_date">
                                            <span data-toggle="tooltip" data-placement="right" title="" data-original-title="Please choose the date to start displaying the banner">
                                                <b style="color: red">&ast;&nbsp;</b>ⓘ
                                            </span>
                                            Start date
                                        </label>
