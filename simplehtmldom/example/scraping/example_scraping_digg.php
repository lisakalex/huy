...
//        $item['title'] = trim($article->find('div[itemprop="alternativeHeadline"]', 0)->plaintext);
        $item['title'] = trim($article->find('div.alternativeHeadline', 0)->plaintext);
        // get details
//        $item['details'] = trim($article->find('p', 0)->plaintext);
        $item['details'] = trim($article->find('h2.headline', 0)->plaintext);
        // get intro
